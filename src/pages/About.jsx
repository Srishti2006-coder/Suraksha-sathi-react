    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-600 to-pink-500 flex flex-col">
      ...
      <div className="flex-grow max-w-6xl mx-auto mt-4 px-4 pb-8 w-full">
        <div className="grid gap-8">
          {/* 1. Hero Section */}
          <div className="bg-white/20 backdrop-blur-lg border border-white/30 rounded-lg p-8">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="p-6 rounded-lg border shadow-sm bg-white/90 backdrop-blur-sm">
          ...
          {/* 3. Our Story */}
          <div className="p-6 rounded-lg bg-white/20 backdrop-blur-sm border border-white/30">
            <h3 className="font-semibold text-white text-lg">Our Story</h3>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="p-4 rounded-lg border bg-white/90 shadow-sm text-center hover:shadow-md transition hover:-translate-y-1 backdrop-blur-sm">
              <div className="text-3xl">🗺️</div>
              <div className="font-semibold mt-3 text-gray-800">Safe Routes</div>
            ...
            <div className="p-4 rounded-lg border bg-white/90 shadow-sm text-center hover:shadow-md transition hover:-translate-y-1 backdrop-blur-sm">
              ...
              <div className="font-semibold mt-3 text-gray-800">SOS Alerts</div>
              <div className="text-sm text-slate-600 mt-1">
            ...
            <div className="p-4 rounded-lg border bg-white/90 shadow-sm text-center hover:shadow-md transition hover:-translate-y-1 backdrop-blur-sm">
              <div className="text-3xl">📣</div>
              <div className="font-semibold mt-3 text-gray-800">Community Reports</div>
              <div className="text-sm text-slate-600 mt-1">
            ...
            <div className="p-4 rounded-lg border bg-white/90 shadow-sm text-center hover:shadow-md transition hover:-translate-y-1 backdrop-blur-sm">
              <div className="text-3xl">🔒</div>
              <div className="font-semibold mt-3 text-gray-800">Privacy</div>
              <div className="text-sm text-slate-600 mt-1">
          ...
          {/* 5. Meet the Team */}
          <div className="bg-white/90 p-6 rounded-lg border shadow-sm backdrop-blur-sm">
            ...
            <div className="mt-4 grid grid-cols-2 sm:grid-cols-4 gap-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-semibold text-gray-800">Shreya Janweja</div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-semibold text-gray-800">Srishti Bansal</div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="font-semibold text-gray-800">Sejal Jain</div>
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            <div className="p-6 rounded-lg bg-gradient-to-br from-indigo-600 to-indigo-500 text-white text-center border border-white/20">
              <div className="text-3xl font-extrabold">1,245</div>
              <div className="mt-2 text-sm">Safe Routes Suggested</div>
            </div>
            <div className="p-6 rounded-lg bg-gradient-to-br from-pink-500 to-pink-400 text-white text-center border border-white/20">
              <div className="text-3xl font-extrabold">320</div>
              <div className="mt-2 text-sm">Areas Reported</div>
            </div>
            <div className="p-6 rounded-lg bg-gradient-to-br from-emerald-500 to-emerald-400 text-white text-center border border-white/20">
          ...
          <div className="p-6 rounded-lg bg-white/90 border shadow-sm backdrop-blur-sm">
            <div className="grid md:grid-cols-2 gap-6 items-center">
              <div>
                ...
                <div className="mt-4">
                  ...
                  <button className="ml-3 px-4 py-2 border rounded-md hover:bg-slate-50 transition text-gray-700">
                    Volunteer
                  </button>
                </div>
              </div>
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className="relative bg-green-500/90 backdrop-blur-lg rounded-2xl shadow-2xl p-6 w-full max-w-sm text-center border border-white/20">
